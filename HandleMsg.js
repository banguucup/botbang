    ...
    try {
        ...
        case 'stiker':
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                aruga.reply(from, 'Gw minta tolong bgt kak, tlong difollow ig saya, susahnya follow doang apa? 👊🙁 https://www.instagram.com/bang_uucup mau difollowback DM saja')
                ...
                aruga.sendStickerfromUrl(from, url).then((r) => (!r && r !== undefined)
                    ...
                    : aruga.reply(from, 'GAUSAH MINTA BUAT STIKER KALAU GA FOLLOW IG SAYA 👊🙁 https://www.instagram.com/bang_uucup')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
            } else {
        ...
        case 'stickergiphy':
            ...
            if (isGiphy) {
                ...
                aruga.sendGiphyAsSticker(from, smallGifUrl).then(() => {
                    aruga.reply(from, 'GAUSAH MINTA BUAT STIKER KALAU GA FOLLOW IG SAYA 👊🙁 https://www.instagram.com/bang_uucup')
                    console.log(`Sticker Processed for ${processTime(t, moment())} Second`)
                ...
                await aruga.reply(from, 'Maaf, format pesan salah silahkan periksa menu, silahkan upload di web giphy dulu video lu!. [Giphy Only]', id)
            }
            break
        case 'meme':
        ...
        case 'nulis':
            ...
            await aruga.sendImage(from, `${nulisp}`, '', 'Succes...*Bot BANG*', id)
            .catch(() => {
        ...
        case 'anime':
            ...
            if (args[0] == 'random' || args[0] == 'waifu' || args[0] == 'husbu' || args[0] == 'neko') {
                ...
                .then(body => {
                    ...
                    aruga.sendFileFromUrl(from, randomnimex, '', 'Succes...Bot BANG*', id)
                })
                .catch(() => {
                    aruga.reply(from, 'Ada yang eror!', id)
                })
        ...
        case 'kpop':
            ...
            if (args[0] == 'blackpink' || args[0] == 'exo' || args[0] == 'bts') {
                ...
                .then(body => {
                    ...
                    aruga.sendFileFromUrl(from, randomkpopx, '', 'Succes... Bot BANG*', id)
                })
                .catch(() => {
                    aruga.reply(from, 'Ada yang eror!', id)
                })
        ...
        case 'resep':
            ...
            aruga.reply(from, hasilresep + '\n\nIni kak resep makanannya.. BOT BANG*', id)
            .catch(() => {
                aruga.reply(from, 'Ada yang eror!', id)
            })
            break
